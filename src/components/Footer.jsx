...
const Footer = () => {
  ...
  return (
    <footer className="bg-white border-t border-gray-200 shadow-inner mt-16 bg-cover bg-center" style={{ backgroundImage: `url(${footerphoto})`, backgroundBlendMode: 'darken', backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-10 text-white">
        {/* Company Info */}
        <div>
          ...
          <div className="flex flex-col gap-2 text-sm text-white">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-white">Shop N.7, Marwana Paradyes,Near Green Meddo School Arrais Waddo Nagoa Goa,403516 India</span>
            </div>
          </div>
        </div>
      ...
      <div className="text-center py-4 text-sm text-white bg-gray-50 border-t border-gray-200">
